...
//==============================================================================
const String Maggs_a2AudioProcessor::getName() const
{
    return JucePlugin_Name;
}

bool Maggs_a2AudioProcessor::acceptsMidi() const
{
...
bool Maggs_a2AudioProcessor::producesMidi() const
{
...
bool Maggs_a2AudioProcessor::isMidiEffect() const
{
   #if JucePlugin_IsMidiEffect
    return true;
   #else
...
double Maggs_a2AudioProcessor::getTailLengthSeconds() const
{
    return 0.0;
}

int Maggs_a2AudioProcessor::getNumPrograms()
{
    return 1;   // NB: some hosts don't cope very well if you tell them there are 0 programs,
                // so this should be at least 1, even if you're not really implementing programs.
}

int Maggs_a2AudioProcessor::getCurrentProgram()
{
    return 0;
}

void Maggs_a2AudioProcessor::setCurrentProgram (int index)
{
}

const String Maggs_a2AudioProcessor::getProgramName (int index)
{
    return {};
}
...
//==============================================================================
void Maggs_a2AudioProcessor::prepareToPlay (double sampleRate, int samplesPerBlock)
{
...
#ifndef JucePlugin_PreferredChannelConfigurations
bool Maggs_a2AudioProcessor::isBusesLayoutSupported (const BusesLayout& layouts) const
{
  #if JucePlugin_IsMidiEffect
...
void Maggs_a2AudioProcessor::processBlock (AudioBuffer<float>& buffer, MidiBuffer& midiMessages)
{
...
AudioProcessorEditor* Maggs_a2AudioProcessor::createEditor()
{
    return new Maggs_a2AudioProcessorEditor (*this);
}

//==============================================================================
void Maggs_a2AudioProcessor::getStateInformation (MemoryBlock& destData)
{
...
void Maggs_a2AudioProcessor::setStateInformation (const void* data, int sizeInBytes)
{
...
void Maggs_a2AudioProcessor:: updateAngleDelta()
{
